...
<footer class="bg-gray-900 text-gray-300 border-t border-gray-800 py-12 mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 leading-relaxed">
                    Nuestra misión es combatir el desperdicio de alimentos conectando a los negocios locales con
                    personas interesadas en rescatar comida de calidad a excelentes precios. Promovemos el bien común,
                    la sostenibilidad ambiental y la responsabilidad social en Arequipa.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 leading-relaxed mb-3">
                    Reconocemos y respetamos la propiedad intelectual y el software libre. Este proyecto académico
                    utiliza las siguientes herramientas y tecnologías de terceros:
                </p>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-xs text-gray-500">
            <p>&copy; {{ date('Y') }} La Alacena. Trabajo Académico para la asignatura de Programación Web. Todos
                los derechos de terceros reservados.</p>
        </div>
    </div>
</footer>
