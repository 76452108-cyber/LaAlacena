...
<body class="font-sans antialiased bg-gray-50 flex flex-col min-h-screen">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('productos.index') }}"
                        class="text-sm bg-gray-200 text-gray-755 px-3 py-2 rounded hover:bg-gray-300 transition">
                        Volver al catálogo
                    </a>
                </div>
            </div>
    ...
    <section class="bg-gradient-to-r from-green-700 to-green-500 text-white py-12">
        <div class="max-w-4xl mx-auto text-center px-4">
            ...
            <p class="mt-3 text-lg opacity-90">Crea ofertas atractivas y ayuda a reducir el desperdicio de comida en
                Arequipa.</p>
        </div>
    </section>
            ...
            <form id="productForm" method="POST" action="{{ route('productos.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" id="stock" placeholder="1"
                            class="w-full border border-gray-300 rounded px-4 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none"
                            required>
                ...
                <div class="flex gap-4">
                    <a href="{{ route('productos.index') }}"
                        class="w-1/3 text-center bg-gray-200 text-gray-700 py-3 rounded-lg hover:bg-gray-300 transition font-semibold">
                        Cancelar
                    </a>
                    <button type="submit"
